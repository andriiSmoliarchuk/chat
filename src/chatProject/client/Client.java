...
import chatProject.Connection;
import chatProject.ConsoleHelper;
import chatProject.Message;
import chatProject.MessageType;
        ...
        protected void clientHandshake() throws IOException, ClassNotFoundException {
            while (true) {
                ...
                if (message.getType() == MessageType.NAME_REQUEST) { // Сервер запросил имя пользователя
                    ...
                    throw new IOException("Unexpected task3008.MessageType");
                }
            }
        }
